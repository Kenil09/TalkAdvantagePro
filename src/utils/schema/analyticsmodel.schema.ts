...
export const analyticsProfileSchema = z.object({
    ...
    curiosityEnginePrompt: z.string().min(1, "Curiosity engine prompt is required"),
...
export type AnalyticsProfileFormDataSchema = z.infer<typeof analyticsProfileSchema>;