...
// import { RecordingHeatmapProps } from '@/types/library.types'
...
//     if (isSelected) return 'bg-emerald-700 dark:bg-emerald-300'
...
//             <div
//               key={i}
//               className="text-center text-xs py-1 font-medium text-slate-600 dark:text-slate-400"
//             >
//               {i + 1}
//             </div>
//           ))}
...
//                             count > 0
//                               ? 'cursor-pointer hover:ring-2 hover:ring-emerald-500/50 dark:hover:ring-emerald-400/50'
//                               : '',
//                           )}
//                           onClick={() =>
//                             count > 0 && onHourSelect(dayIndex, hour, [])
//                           }
//                         />
//                       </TooltipTrigger>
//                       <TooltipContent
...
//                           {count} recording{count !== 1 ? 's' : ''} on{' '}
//                           {format(date, 'MMMM do')} at {format(date, 'HH:mm')}
//                         </p>
//                       </TooltipContent>
//                     </Tooltip>
//                   </TooltipProvider>
...
//     const totalRecordings = recordings.filter(
//       (r) => new Date(r.created_at).getFullYear() === selectedYear,
//     ).length
...
//                 <div
//                   key={month}
//                   className="flex-1 text-sm font-medium text-slate-500 dark:text-slate-400"
//                 >
//                   {month.substring(0, 3)}
//                 </div>
//               ))}
...
//                   <div
//                     key={day}
//                     className="h-[15px] text-[11px] leading-[15px] text-right font-medium text-slate-500 dark:text-slate-400"
//                   >
//                     {day}
//                   </div>
//                 ))}
...
//                                     count > 0 && isCurrentYear
//                                       ? 'cursor-pointer hover:scale-110 hover:shadow-lg hover:ring-2 hover:ring-emerald-400/60 dark:hover:ring-emerald-400/40'
//                                       : '',
//                                   )}
//                                   onClick={() => {
...
//                 <div
//                   key={hour}
//                   className="text-center text-[10px] py-1 text-slate-500 dark:text-slate-400"
//                 >
//                   {hour}
//                 </div>
//               ))}
...
//                       selectedCell?.hour === hourIndex
//                     const cellClass = getCellClass(intensity, isSelected)
//                     const recordingsForCell = getRecordingsForCell(
//                       dayIndex,
//                       hourIndex,
//                     )
//                     return (
...
//                                 {day} {hourIndex}:00-{(hourIndex + 1) % 24}:00
//                               </p>
//                               <p className="text-xs">
...
//                             )}
//                             onClick={() =>
//                               count > 0 && handleCellClick(dayIndex, hourIndex)
//                             }
//                           >
//                             {count > 0 && count}
//                           </div>
...
//               Less → More recordings
//             </span>
//           </div>
//           <div className="text-xs text-slate-500 dark:text-slate-400">
//             {weekRecordings.length} recording
//             {weekRecordings.length !== 1 ? 's' : ''} this week
//           </div>
//         </div>
//       </div>
//     )
...
//   return (
//     <Card className={cn('shadow-md overflow-hidden pt-0', className)}>
...
//         <div className="overflow-x-auto">{renderHeatmapGrid()}</div>
//       </CardContent>
//     </Card>
//   )
// }
